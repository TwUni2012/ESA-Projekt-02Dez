...
public class RestFulNewsGui extends Container {
	...
	public RestFulNewsGui() {
				...
				if(e.getEventType() == HyperlinkEvent.EventType.ACTIVATED) {
					...
					try {
						...
						articleDialog.setHtml("<html><body bgcolor=#ffffff><center><font color=#ff0000 face=verdana><b>" +
								e1.getMessage()+ "</b></font></center></body></html>", e1.getMessage());
					} 
				}
			}
		});
		...
		northContainer.add(new JLabel("<html><body bgcolor=#ffffff><font size=3 face=courier>&nbsp;"+WebFrontend.SERVER_URL+"</body></html>"));
